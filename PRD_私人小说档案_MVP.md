...
- `私人阅读器 + 个人档案工具`
- 只支持用户上传、导入或手动登记其自行持有的文档与阅读记录
- 不提供任何平台内置小说内容
- 不提供小说搜索聚合、在线抓取、下载、搬运或分发能力
- 不鼓励、不协助用户获取未授权内容

也就是说，这个 App 只能作为用户阅读自己上传文档的工具，而不能演变成内容平台或资源分发平台，否则会带来严重版权风险。
...
- `用户自带内容`：只处理用户自行上传、导入或登记的内容，不提供平台内容
- `合规边界清晰`：不做抓取、不做聚合、不做下载、不做侵权分发
...
- 平台不提供任何小说正文内容
- 平台不内置书源或资源站
- 平台不提供爬取、检索盗版站、自动下载或转存能力
- 外部链接仅作为用户个人备注，不作为平台分发能力的一部分
...
- 用户手动输入
- AI 根据书名、简介、用户笔记、用户上传的 TXT、OCR 内容生成候选 Tag
- 从已有 Tag 词库中推荐
...
- AI 只处理用户手动输入或用户上传的文本内容
- AI 不生成完整小说内容，不补全正文，不提供替代阅读来源
- AI 不连接外部站点抓取小说，不提供未授权内容整理与搬运
